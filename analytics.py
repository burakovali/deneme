...
def count_missing_values(didbName='didb', write_to_file=True):
    ...
    print(str(assoc_req_spatial_stream)+" of them are missing assoc request|%"+str(100-100*(len(df) - wfa_device_name)/len(df)))
    print(str(assoc_req_vendors)+" of them are missing assoc request vendor|%"+str(100-100*(len(df) - wfa_device_name)/len(df)))
