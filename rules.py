...
model_rules =[rules_model.mark_model_iphone, rules_model.mark_model_ipad, rules_model.mark_model_ipadPro,
               ...
               rules_model.mark_model_air4443, rules_model.mark_model_nintendo, rules_model.mark_model_oneday]
...
deviceType_rules = [rules_deviceType.mark_deviceType_mobile, rules_deviceType.mark_deviceType_laptop, rules_deviceType.mark_deviceType_gamingConsole, rules_deviceType.mark_deviceType_tv, rules_deviceType.mark_deviceType_tablet, rules_deviceType.mark_deviceType_homeDevice]
